...
class ResearchCrewTasks:
    def research_task(self, agent, inputs):
        return Task(
            ...
            expected_output="A clear explanation of the principles, concepts, disciplines, and skills needed by the visionary in order to accomoplish their goal",
        )
    ...
    def analysis_task(self, agent, context):
        return Task(
            ...
            expected_output="A thorough learning plan for the next agent",
        )
    ...
    def writing_task(self, agent, context, inputs):
        return Task(
            ...
            expected_output=" 5 principles and concepts reviewed, and thoroughly explaiened , 5 internet articles titles and their URL,  5 books name and author and their purpose.",
        )
